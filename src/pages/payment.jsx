                                            ...
                                            <div className="card-body d-block text-left p-0">
                                                <div className="item w-100 h150 bg-white rounded-xxl overflow-hidden text-left shadow-md ps-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card border-0 shadow-none p-0 bg-transparent-card text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <img src="images/b-9.png" alt="icon" className="w40 float-left d-inline-block" />
                                                            </div>
                                                            <div className="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" className="w30 float-right d-inline-block mt-2 me-2" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="card-body d-block text-left p-0">
                                                <div className="item w-100 h150 bg-gold-gradiant rounded-xxl overflow-hidden text-left shadow-md ps-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <img src="images/b-14.png" alt="icon" className="w90 float-left d-inline-block" />
                                                            </div>
                                                            <div className="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" className="w30 float-right d-inline-block mt-2 me-2 rounded-xxl" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="card-body d-block text-left p-0">
                                                <div className="item w-100 h150 bg-primary rounded-xxl text-left shadow-md ps-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <img src="images/b-10.png" alt="icon" className="w40 float-left d-inline-block" />
                                                            </div>
                                                            <div className="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" className="w30 float-right d-inline-block mt-2 me-2 rounded-3" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100 mt-auto">
                                                    ...
                                                    <div className="card border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6 ps-2">
                                                                <img src="images/b-17.png" alt="icon" className="w60 float-left d-inline-block" />
                                                            </div>
                                                            <div className="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" className="w30 float-right d-inline-block mt-2 me-2" />
                                                            </div>
                                            ...
                                            <div className="col-lg-12 mt-5">
                                                <form>
                                                    <div className="form-group mb-1">
                                                        <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="cardNumber">Card Number</label>
                                                    ...
                                                    <div className="form-group mb-1">
                                                        <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="cardHolderName">Card Holder Name</label>
                                                        <div className="form-group icon-tab">
                                                            <input
                                                                type="text"
                                                    ...
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <div className="form-group mb-1">
                                                                <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="expiryMonth">Month</label>
                                                                <div className="form-group icon-tab">
                                                                    <input
                                                                        type="text"
                                                                        className="bg-white border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900"
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group mb-1">
                                                                <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="expiryYear">Year</label>
                                                                <div className="form-group icon-tab">
                                                                    <input
                                                                        type="text"
                                                                        className="bg-white border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900"
