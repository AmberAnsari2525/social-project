...
export const DefaultEmailOpen = () => {

    const messages = [
        {
            id: 'one',
            userImage: 'images/user-8.png',
            userName: 'Aenni Mirenda',
            date: '14.09.2020 10:23',
            message: `Hi Aenni, <br> <br> All individual Framer subscriptions have been grandfathered into a Pro plan at your existing rate. If you were on a Small Team plan, then all 5 seats have been converted over to Pro seats at your existing rate. <br><br> Regards,<br>Jessica`,
        },
        {
            id: 'two',
            userImage: 'images/icon2.png',
            userName: 'You',
            date: '14.09.2020 11:45',
            message: `Hi Aenni, <br> <br> All individual Framer subscriptions have been grandfathered into a Pro plan at your existing rate. If you were on a Small Team plan, then all 5 seats have been converted over to Pro seats at your existing rate. <br><br> Regards,<br>Jessica`,
        },
        {
            id: 'three',
                                    ...
                                    <div className="chat-body p-lg-4 p-3 mt-lg-3 mt-0">
                                        <div className="card dark-bg-transparent border-0 w-100 p-0 mb-3 shadow-none">
                                            <div className="card-body p-0">
                                                <h6 className="fw-600 text-grey-500 font-xsssss">Today, 16th September
                                                    2020, 11:45</h6>
                                        ...
                                        <div className="panel-group" id="accordion" role="tablist"
                                            ...
                                            {messages.map((msg) => (
                                                <div key={msg.id}
                                                     className="panel panel-default p-0 bg-transparent border-bottom rounded-0">
                                                    <div className="panel-heading pb-2" role="tab"
                                                         id={`heading${msg.id}`}>
                                                        <a
                                                            className="panel-title fw-400 mb-0 accordion-toggle icon-none d-flex justify-content-between pe-0"
                                                            data-toggle="collapse"
                                                            data-parent="#accordion"
                                                            href={`#collapse${msg.id}`}
                                                            aria-expanded="false"
                                                            aria-controls={`collapse${msg.id}`}
                                                        >
                                                            <figure className="avatar me-2 mb-0 w35 mt-1 pt-1">
                                                                <img src={msg.userImage} alt="image"
                                                                     className="float-right shadow-sm rounded-circle w-100"/>
                                                            </figure>
                                                            <span
                                                                className="font-xssss text-grey-700 pt-2 mt-1 ps-2 fw-700 mb-0 me-auto text-dark">
                                {msg.userName}
                              </span>
                                                            <span
                                                                className="font-xssss text-grey-500 pt-2 mt-1 ps-2 fw-600 mb-0 ms-auto">{msg.date}</span>
                                                        </a>
                                                    </div>
                                                    <div
                                                        id={`collapse${msg.id}`}
                                                        ...
                                                        style={msg.hasReplyBox ? {display: 'block'} : {}}
                                                    >
                                                        <p
                                                            className="text-grey-600 mb-4 font-xsss lh-28 fw-500 mt-3"
