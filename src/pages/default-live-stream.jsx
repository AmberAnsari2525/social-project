...
export const DefaultLiveStream = () => {
    return (
        <>
            {/* Main content start */}
            <div className="right-chat-active">
                            ...
                            <div className="col-xl-8 col-xxl-9 col-lg-8">
                                ...
                                >
                                    ...
                                    <div className="card-body text-center p-2 position-absolute w-100 bottom-0 bg-gradiant-bottom">
                                        <a href="#" className="btn-round-xl d-md-inline-block d-none bg-blur m-3 me-0 z-index-1">
                                            <i className="feather-grid text-white font-md"></i>
                                        </a>
                                        <a href="#" className="btn-round-xl d-md-inline-block d-none bg-blur m-3 z-index-1">
                                        ...
                                        <a href="#" className="btn-round-xl d-md-inline-block d-none bg-blur m-3 ms-0 z-index-1">
                                        ...
                                        <span className="live-tag position-absolute left-15 mt-2 bottom-0 mb-4 bg-danger p-2 z-index-1 rounded-3 text-white font-xsssss text-uppercase fw-700 ls-3">
                                            LIVE
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="card w-100 d-block chat-body p-0 border-0 shadow-xss rounded-3 mb-3 position-relative">
                                    ...
                                    <form className="chat-form position-absolute bottom-0 w-100 left-0 bg-white z-index-1 p-3 shadow-xs theme-dark-bg">
                                        ...
                                        <div className="form-group">
                                            <input type="text" placeholder="Start typing.." className="pos-top text-grey-900" />
                                        </div>
